...
{
    public partial class frm_MainIngredWorkLog : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void XMain_Search()
        {
            try
            {
                ...
                FROM BIN_INGRED_INPUT bii
                    JOIN INGRED i ON i.PLANT_CODE = bii.PLANT_CODE AND NVL(i.MS_GUBUN, 'M') = 'M' AND i.RESOURCE_NO = bii.RESOURCE_NO
        ...
        private void frm_MainIngredWorkLog_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            {
                clsLog.logSave(this, "frm_MainIngredWorkLog_Load", ex);
        ...
        private void btn_report_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                clsPrintReport.PrintMainIngredWorkLog(dtWork.EditValue.ToString(), dsMain);
            }
            catch (Exception ex)
            {
