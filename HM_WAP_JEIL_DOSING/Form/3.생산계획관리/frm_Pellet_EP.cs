...
{
    public partial class frm_Pellet_EP : DevExpress.XtraEditors.XtraForm
    {
        DataSet authDs;
        ...
        public frm_Pellet_EP(string plant_code, string process_key, string formName, string sProcessName)
        {
            InitializeComponent();
            formname = formName;
        ...
        private void frm_Pellet_EP_Load(object sender, EventArgs e)
        {
            ...
            dateEdit_workDateEd.EditValue = vPlant_Code == "PJ02" ? DateTime.Today : DateTime.Today.AddDays(1);
        ...
        private void XMain_Search()
        {
            try
            {
                ...
                SELECT 
                    ...
                    QTY, REMAIN_QTY, ROUND((RUN_ET - RUN_ST) * 24, 2) AS WORK_HOUR, PROTY, 
                ...
                ORDER BY ERP_UP_YN DESC,WORKDATE DESC, RUN_ST DESC, RUN_ET DESC, WORK_SEQ DESC
                ";
        ...
        private void btnERPDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (int rowHandle in selectedRows)
                {
                    ...
                    WHERE PLANT_CODE = '{dr["PLANT_CODE"]}' AND PROCESS_KEY = '{dr["PROCESS_KEY"]}' AND L_CODE = '{dr["L_CODE"]}'
                        AND WORKDATE = TO_CHAR(TO_DATE('{dr["WORKDATE"]}', 'YYYY-MM-DD'), 'YYYYMMDD') AND WORK_SEQ = '{dr["WORK_SEQ"]}'
                        AND (ERP_OSTATUS IN ('Y') OR ERP_ISTATUS IN ('Y'))
                    ";
        ...
        private void gridView_CustomSummaryCalculate(object sender, DevExpress.Data.CustomSummaryEventArgs e)
        {
            ...
            if (e.SummaryProcess == DevExpress.Data.CustomSummaryProcess.Calculate)
            {
                ...
                decimal qty = Convert.ToDecimal(view.GetRowCellValue(rowHandle, "QTY") == DBNull.Value ? 0 : view.GetRowCellValue(rowHandle, "QTY"));
