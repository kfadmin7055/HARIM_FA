...
namespace HARIM_FA_DOSING.Class
{
    public class PlcFunc_Test2
    {
        ...
        public static int[] PlcGetReadDeviceAddBlock(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int iPLCUnit, int iPLCDataCount, DataRow dr, int Dev, int j, string device, string number, string sErrMsg, int[] Cimon_Result_Data, string sWorkDate = "", string sWorkNum = "")
        {
            ...
            if (clsCommon.PlantCode == "PJ01" && clsCommon.GetProcessKey("갓돈배합") == clsCommon.ProcessCode)
            {
                MAIN_Test2.aPlc2.ReadADeviceAddBlockEx(device, int.Parse(number), (5 * j), iPLCDataCount, out valData, sErrMsg);
                return valData;
            }
            // GBG4 -
            ...
            if (iPlc_Location == 1 && dtPlc.Rows[iPlc_Location - 1]["PLC_TYPE"]?.ToString() == "Q")
            {
                ...
                for (int k = 0; k < 3; k++)
                {
                    MAIN_Test2.qPlc1.ReadQDeviceAddBlockEx(device, int.Parse(number), (5 * j), iPLCDataCount, out valData, sErrMsg);
                }
            }
            else if (iPlc_Location == 1 && dtPlc.Rows[iPlc_Location - 1]["PLC_TYPE"]?.ToString() == "A")
            {
                ...
                for (int k = 0; k < 3; k++)
                {
                    MAIN_Test2.aPlc1.ReadADeviceAddBlockEx(device, int.Parse(number), (5 * j), iPLCDataCount, out valData, sErrMsg);
                }
            }
            else if (iPlc_Location == 2 && dtPlc.Rows[iPlc_Location - 1]["PLC_TYPE"]?.ToString() == "Q")
            {
                ...
                for (int k = 0; k < 3; k++)
                {
                    MAIN_Test2.qPlc2.ReadQDeviceAddBlockEx(device, int.Parse(number), (5 * j), iPLCDataCount, out valData, sErrMsg);
                }
            }
            else if (iPlc_Location == 2 && dtPlc.Rows[iPlc_Location - 1]["PLC_TYPE"]?.ToString() == "A")
            {
        ...
        public static bool PlcGetReadQDeviceBlockEx(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int iPLCUnit, int iPLCDataCount, ref int[] pWorkNum, string sErrMsg, int[] Cimon_Job_Data = null, int sourceIndex = 0)
        {
            ...
            {
                if (MAIN_Test2.qPlc1.ReadQDeviceBlockEx(sPLCAddress, iPLCDataCount, out pWorkNum, sErrMsg) != 0)
                {
                    clsLog.logSave($"**********MAIN_Test2.qPlc1.ReadQDeviceBlockEx 접속이 끊겼습니다.**********", 0, "PLC");
                    MAIN_Test2.MainPlcConnChk = "N";
                    return false;
                }
                else
                {
                    MAIN_Test2.MainPlcConnChk = "Y";
                }
            }
            // GBG
            else if (iPlc_Location == 1 && sPlcType == "A")
            {
                if (MAIN_Test2.aPlc1.ReadADeviceBlockEx(sPLCAddress, iPLCDataCount, out pWorkNum, sErrMsg) != 0)
                {
                    clsLog.logSave($"**********MAIN_Test2.aPlc1.ReadADeviceBlockEx 접속이 끊겼습니다.**********", 0, "PLC");
                    MAIN_Test2.MainPlcConnChk = "N";
                    returnBool = false;
                }
                else
            ...
            {
                if (MAIN_Test2.qPlc2.ReadQDeviceBlockEx(sPLCAddress, iPLCDataCount, out pWorkNum, sErrMsg) != 0)
                {
                    clsLog.logSave($"**********MAIN_Test2.qPlc2.ReadQDeviceBlockEx 접속이 끊겼습니다.**********", 0, "PLC");
                    MAIN_Test2.MainPlcConnChk = "N";
                    returnBool = false;
                }
                else
            ...
            {
                if (MAIN_Test2.aPlc2.ReadADeviceBlockEx(sPLCAddress, iPLCDataCount, out pWorkNum, sErrMsg) != 0)
                {
                    clsLog.logSave($"**********MAIN_Test2.aPlc2.ReadADeviceBlockEx 접속이 끊겼습니다.**********", 0, "PLC");
                    MAIN_Test2.MainPlcConnChk = "N";
                    returnBool = false;
                }
                else
        ...
        public static bool PLCSetWriteQDeviceBlock2Ex(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int iPLCUnit, int iPLCDataCount, ref short[] Sdata, int[] Sdata2, string sErrMsg = "")
        {
            ...
            if (iPlc_Location == 1 && sPlcType == "Q")
            {
                if (MAIN_Test2.qPlc1.WriteQDeviceBlock2Ex(sPLCAddress, iPLCDataCount, ref Sdata, sErrMsg) != 0)
                {
                    clsLog.logSave($"**********MAIN_Test2.qPlc1.WriteQDeviceBlock2Ex 접속이 끊겼습니다.**********", 0, "PLC");
                    MAIN_Test2.MainPlcConnChk = "N";
                    return false;
                }
                else
            ...
            {
                if (MAIN_Test2.aPlc1.WriteADeviceBlock2Ex(sPLCAddress, iPLCDataCount, ref Sdata, sErrMsg) != 0)
                {
                    clsLog.logSave($"**********MAIN_Test2.aPlc1.WriteADeviceBlock2Ex 접속이 끊겼습니다.**********", 0, "PLC");
                    MAIN_Test2.MainPlcConnChk = "N";
                    return false;
                }
                else
            ...
            {
                if (MAIN_Test2.qPlc2.WriteQDeviceBlock2Ex(sPLCAddress, iPLCDataCount, ref Sdata, sErrMsg) != 0)
                {
                    clsLog.logSave($"**********MAIN_Test2.qPlc2.WriteQDeviceBlock2Ex 접속이 끊겼습니다.**********", 0, "PLC");
                    MAIN_Test2.SubPlcConnChk = "N";
                    return false;
                }
                else
                {
                    MAIN_Test2.SubPlcConnChk = "Y";
                }
            }
            else if (iPlc_Location == 2 && sPlcType == "A")
            {
                if (MAIN_Test2.aPlc2.WriteADeviceBlock2Ex(sPLCAddress, iPLCDataCount, ref Sdata, sErrMsg) != 0)
                {
                    clsLog.logSave($"**********MAIN_Test2.aPlc2.WriteADeviceBlock2Ex 접속이 끊겼습니다.**********", 0, "PLC");
                    MAIN_Test2.SubPlcConnChk = "N";
                    return false;
                }
                else
        ...
        public static bool PlcSetQDeviceEx(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int iPLCUnit, int iPLCDataCount, DataRow dr, int batch, int[] pWorkNum, string sErrMsg)
        {
            ...
            {
                if (MAIN_Test2.qPlc1.SetQDeviceEx(sPLCAddress, pWorkNum[0], sErrMsg) != 0)
                {
                    clsLog.logSave($"**********MAIN_Test2.qPlc1.SetQDeviceEx 접속이 끊겼습니다.**********", 0, "PLC");
                    MAIN_Test2.MainPlcConnChk = "N";
                    returnBool = false;
                }
                else
            ...
            {
                if (MAIN_Test2.aPlc1.SetADeviceEx(sPLCAddress, pWorkNum[0], sErrMsg) != 0)
                {
                    clsLog.logSave($"**********MAIN_Test2.aPlc1.SetADeviceEx 접속이 끊겼습니다.**********", 0, "PLC");
                    MAIN_Test2.MainPlcConnChk = "N";
                    returnBool = false;
                }
                else
            ...
            {
                if (MAIN_Test2.qPlc2.SetQDeviceEx(sPLCAddress, pWorkNum[0], sErrMsg) != 0)
                {
                    clsLog.logSave($"**********MAIN_Test2.qPlc2.SetQDeviceEx 접속이 끊겼습니다.**********", 0, "PLC");
                    MAIN_Test2.MainPlcConnChk = "N";
                    returnBool = false;
                }
                else
            ...
            {
                if (MAIN_Test2.aPlc2.SetADeviceEx(sPLCAddress, pWorkNum[0], sErrMsg) != 0)
                {
                    clsLog.logSave($"**********MAIN_Test2.aPlc2.SetADeviceEx 접속이 끊겼습니다.**********", 0, "PLC");
                    MAIN_Test2.MainPlcConnChk = "N";
                    returnBool = false;
                }
                else
        ...
        public static bool PlcSetWriteQDeviceAddBlockEx(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int iPLCUnit, int iPLCDataCount, int Dev, int j, ref int[] pWorkNum, int[] Recipe_Data, ref int Recipe_D1_Index, ref int Recipe_D2_Index, ref int Recipe_D3_Index, ref int Recipe_L1_Index, ref int Recipe_L2_Index, string device, string number, string sErrMsg)
        {
            ...
            if (sPlcType == "Q" && iPlc_Location == 1)
            {
                if (MAIN_Test2.qPlc1.WriteQDeviceAddBlockEx(device, int.Parse(number), (j * 5), iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            // GBG
            else if (sPlcType == "A" && iPlc_Location == 1)
            {
                if (MAIN_Test2.aPlc1.WriteADeviceAddBlockEx(device, int.Parse(number), (j * 5), iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            else if (sPlcType == "Q" && iPlc_Location == 2)
            {
                if (MAIN_Test2.qPlc2.WriteQDeviceAddBlockEx(device, int.Parse(number), (j * 5), iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            // GBG
            else if (sPlcType == "A" && iPlc_Location == 2)
            {
                if (MAIN_Test2.aPlc2.WriteADeviceAddBlockEx(device, int.Parse(number), (j * 5), iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            else if (sPlcType == "XGI")
            {
        ...
        public static bool SetWriteQDeviceBlockEx(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int iPLCUnit, int iPLCDataCount, ref int[] pWorkNum, string sErrMsg)
        {
            ...
            if (sPlcType == "Q" && iPlc_Location == 1)
            {
                ...
                if (MAIN_Test2.qPlc1.WriteQDeviceBlockEx(sPLCAddress, iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            // GBG
            else if (sPlcType == "A" && iPlc_Location == 1)
            {
                if (MAIN_Test2.aPlc1.WriteADeviceBlockEx(sPLCAddress, iPLCDataCount, pWorkNum, sErrMsg) != 0)
                    return false;
            }
            else if (sPlcType == "Q" && iPlc_Location == 2)
            {

                if (MAIN_Test2.qPlc2.WriteQDeviceBlockEx(sPLCAddress, iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            // GBG
            else if (sPlcType == "A" && iPlc_Location == 2)
            {
                if (MAIN_Test2.aPlc2.WriteADeviceBlockEx(sPLCAddress, iPLCDataCount, pWorkNum, sErrMsg) != 0)
                    return false;
            }
            else if (sPlcType == "XGI")
            {
        ...
        public static bool GetPlcCon(DataTable dt, out string sMsg)
        {
            ...
            {
                case 1:
                    if ((dt.Rows[0]["PLC_TYPE"]?.ToString() == "Q" && MAIN_Test2.MainPlcConnChk != "Y" && clsCommon._strMainPlcConnYn == "Y"))
                    {
                    ...
                    if (dt.Rows[0]["PLC_TYPE"]?.ToString() == "A" && MAIN_Test2.SubPlcConnChk != "Y")
                    {
                    ...
                    // GBG
                    if (dt.Rows[0]["PLC_TYPE"]?.ToString() == "XGI" && MAIN_Test2.MainPlcConnChk != "Y")
                    {
                        //ShowMessageBox.XtraShowInformation("PLC 1번을 연결 해주세요.");
                    ...
                    if (dt.Rows[0]["PLC_TYPE"]?.ToString() == "CM" && MAIN_Test2.MainPlcConnChk != "Y")
                    {
                        //ShowMessageBox.XtraShowInformation("PLC 1번을 연결 해주세요.");
                        sMsg = "PLC 1번을 연결 해주세요.";
                        return false;
                    ...
                    break;
                case 2:
                    if (MAIN_Test2.SubPlcConnChk != "M" && MAIN_Test2.SubPlcConnChk != "")
                    {
                        if ((dt.Rows[1]["PLC_TYPE"]?.ToString() == "Q" && MAIN_Test2.SubPlcConnChk != "Y" && clsCommon._strSubPlcConnYn == "Y"))
                        {
                            //ShowMessageBox.XtraShowInformation("PLC 1번을 연결 해주세요.");
                            sMsg = "PLC 1번 을 연결 해주세요.";
                            return false;
                        ...
                        if (dt.Rows[1]["PLC_TYPE"]?.ToString() == "A" && MAIN_Test2.SubPlcConnChk != "Y")
                        {
                            //ShowMessageBox.XtraShowInformation("PLC 1번, 2번 을 먼저 연결 해주세요.");
                            sMsg = "PLC 2번 을 연결 해주세요.";
                            return false;
                        ...
                        if ((MAIN_Test2.MainPlcConnChk != "Y" && clsCommon._strMainPlcConnYn == "Y") || (MAIN_Test2.SubPlcConnChk != "Y" && clsCommon._strSubPlcConnYn == "Y"))
                        {
                            //ShowMessageBox.XtraShowInformation("PLC 1번, 2번 을 먼저 연결 해주세요.");
