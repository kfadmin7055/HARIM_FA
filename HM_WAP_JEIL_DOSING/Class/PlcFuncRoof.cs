...
namespace HARIM_FA_DOSING.Class
{
    public class PlcFuncRoof
    {
        ...
        public static int[] PlcGetReadDeviceAddBlock(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int iPLCUnit, int iPLCDataCount, DataRow dr, int Dev, int j, string device, string number, string sErrMsg, int[] Cimon_Result_Data, string sWorkDate = "", string sWorkNum = "")
        {
            ...
            if (clsCommon.PlantCode == "PJ01" && clsCommon.GetProcessKey("갓돈배합") == clsCommon.ProcessCode)
            {
                MAINRoof.aPlc2.ReadADeviceAddBlockEx(device, int.Parse(number), (5 * j), iPLCDataCount, out valData, sErrMsg);
                return valData;
            }
            // GBG4 -
            ...
            if (iPlc_Location == 1 && dtPlc.Rows[iPlc_Location - 1]["PLC_TYPE"]?.ToString() == "Q")
            {
                ...
                for (int k = 0; k < 3; k++)
                {
                    MAINRoof.qPlc1.ReadQDeviceAddBlockEx(device, int.Parse(number), (5 * j), iPLCDataCount, out valData, sErrMsg);
                }
            }
            else if (iPlc_Location == 1 && dtPlc.Rows[iPlc_Location - 1]["PLC_TYPE"]?.ToString() == "A")
            {
                ...
                for (int k = 0; k < 3; k++)
                {
                    MAINRoof.aPlc1.ReadADeviceAddBlockEx(device, int.Parse(number), (5 * j), iPLCDataCount, out valData, sErrMsg);
                }
            }
            else if (iPlc_Location == 2 && dtPlc.Rows[iPlc_Location - 1]["PLC_TYPE"]?.ToString() == "Q")
            {
                ...
                for (int k = 0; k < 3; k++)
                {
                    MAINRoof.qPlc2.ReadQDeviceAddBlockEx(device, int.Parse(number), (5 * j), iPLCDataCount, out valData, sErrMsg);
                }
            }
            else if (iPlc_Location == 2 && dtPlc.Rows[iPlc_Location - 1]["PLC_TYPE"]?.ToString() == "A")
            {
        ...
        public static bool PlcGetReadQDeviceBlockEx(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int iPLCUnit, int iPLCDataCount, ref int[] pWorkNum, string sErrMsg, int[] Cimon_Job_Data = null, int sourceIndex = 0)
        {
            ...
            {
                if (MAINRoof.qPlc1.ReadQDeviceBlockEx(sPLCAddress, iPLCDataCount, out pWorkNum, sErrMsg) != 0)
                {
                    MAINRoof.MainPlcConnChk = "N";
                    return false;
                }
                else
                {
                    MAINRoof.MainPlcConnChk = "Y";
                }
            }
            // GBG
            else if (iPlc_Location == 1 && sPlcType == "A")
            {
                if (MAINRoof.aPlc1.ReadADeviceBlockEx(sPLCAddress, iPLCDataCount, out pWorkNum, sErrMsg) != 0)
                {
                    MAINRoof.MainPlcConnChk = "N";
                    returnBool = false;
                }
            ...
            {
                if (MAINRoof.qPlc2.ReadQDeviceBlockEx(sPLCAddress, iPLCDataCount, out pWorkNum, sErrMsg) != 0)
                {
                    MAINRoof.MainPlcConnChk = "N";
                    returnBool = false;
                }
            ...
            {
                if (MAINRoof.aPlc2.ReadADeviceBlockEx(sPLCAddress, iPLCDataCount, out pWorkNum, sErrMsg) != 0)
                {
                    MAINRoof.MainPlcConnChk = "N";
                    returnBool = false;
                }
        ...
        public static bool PLCSetWriteQDeviceBlock2Ex(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int iPLCUnit, int iPLCDataCount, ref short[] Sdata, int[] Sdata2, string sErrMsg = "")
        {
            ...
            if (iPlc_Location == 1 && sPlcType == "Q")
            {
                if (MAINRoof.qPlc1.WriteQDeviceBlock2Ex(sPLCAddress, iPLCDataCount, ref Sdata, sErrMsg) != 0)
                {
                    MAINRoof.MainPlcConnChk = "N";
                    return false;
                }
            ...
            {
                if (MAINRoof.aPlc1.WriteADeviceBlock2Ex(sPLCAddress, iPLCDataCount, ref Sdata, sErrMsg) != 0)
                {
                    MAINRoof.MainPlcConnChk = "N";
                    return false;
                }
            ...
            {
                if (MAINRoof.qPlc2.WriteQDeviceBlock2Ex(sPLCAddress, iPLCDataCount, ref Sdata, sErrMsg) != 0)
                {
                    MAINRoof.SubPlcConnChk = "N";
                    return false;
                }
                else
                {
                    MAINRoof.SubPlcConnChk = "Y";
                }
            }
            else if (iPlc_Location == 2 && sPlcType == "A")
            {
                if (MAINRoof.aPlc2.WriteADeviceBlock2Ex(sPLCAddress, iPLCDataCount, ref Sdata, sErrMsg) != 0)
                {
                    MAINRoof.SubPlcConnChk = "N";
                    return false;
                }
        ...
        public static bool PlcSetQDeviceEx(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int iPLCUnit, int iPLCDataCount, DataRow dr, int batch, int[] pWorkNum, string sErrMsg)
        {
            ...
            {
                if (MAINRoof.qPlc1.SetQDeviceEx(sPLCAddress, pWorkNum[0], sErrMsg) != 0)
                {
                    MAINRoof.MainPlcConnChk = "N";
                    returnBool = false;
                }
            ...
            {
                if (MAINRoof.aPlc1.SetADeviceEx(sPLCAddress, pWorkNum[0], sErrMsg) != 0)
                {
                    MAINRoof.MainPlcConnChk = "N";
                    returnBool = false;
                }
            ...
            {
                if (MAINRoof.qPlc2.SetQDeviceEx(sPLCAddress, pWorkNum[0], sErrMsg) != 0)
                {
                    MAINRoof.MainPlcConnChk = "N";
                    returnBool = false;
                }
            ...
            {
                if (MAINRoof.aPlc2.SetADeviceEx(sPLCAddress, pWorkNum[0], sErrMsg) != 0)
                {
                    MAINRoof.MainPlcConnChk = "N";
                    returnBool = false;
                }
        ...
        public static bool PlcSetWriteQDeviceAddBlockEx(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int iPLCUnit, int iPLCDataCount, int Dev, int j, ref int[] pWorkNum, int[] Recipe_Data, ref int Recipe_D1_Index, ref int Recipe_D2_Index, ref int Recipe_D3_Index, ref int Recipe_L1_Index, ref int Recipe_L2_Index, string device, string number, string sErrMsg)
        {
            ...
            if (sPlcType == "Q" && iPlc_Location == 1)
            {
                if (MAINRoof.qPlc1.WriteQDeviceAddBlockEx(device, int.Parse(number), (j * 5), iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            // GBG
            else if (sPlcType == "A" && iPlc_Location == 1)
            {
                if (MAINRoof.aPlc1.WriteADeviceAddBlockEx(device, int.Parse(number), (j * 5), iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            else if (sPlcType == "Q" && iPlc_Location == 2)
            {
                if (MAINRoof.qPlc2.WriteQDeviceAddBlockEx(device, int.Parse(number), (j * 5), iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            // GBG
            else if (sPlcType == "A" && iPlc_Location == 2)
            {
                if (MAINRoof.aPlc2.WriteADeviceAddBlockEx(device, int.Parse(number), (j * 5), iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            else if (sPlcType == "XGI")
            {
        ...
        public static bool SetWriteQDeviceBlockEx(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int iPLCUnit, int iPLCDataCount, ref int[] pWorkNum, string sErrMsg)
        {
            ...
            if (sPlcType == "Q" && iPlc_Location == 1)
            {
                ...
                if (MAINRoof.qPlc1.WriteQDeviceBlockEx(sPLCAddress, iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            // GBG
            else if (sPlcType == "A" && iPlc_Location == 1)
            {
                if (MAINRoof.aPlc1.WriteADeviceBlockEx(sPLCAddress, iPLCDataCount, pWorkNum, sErrMsg) != 0)
                    return false;
            }
            else if (sPlcType == "Q" && iPlc_Location == 2)
            {

                if (MAINRoof.qPlc2.WriteQDeviceBlockEx(sPLCAddress, iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            // GBG
            else if (sPlcType == "A" && iPlc_Location == 2)
            {
                if (MAINRoof.aPlc2.WriteADeviceBlockEx(sPLCAddress, iPLCDataCount, pWorkNum, sErrMsg) != 0)
                    return false;
            }
            else if (sPlcType == "XGI")
            {
        ...
        public static bool GetPlcCon(DataTable dt, out string sMsg)
        {
            ...
            {
                case 1:
                    if ((dt.Rows[0]["PLC_TYPE"]?.ToString() == "Q" && MAINRoof.MainPlcConnChk != "Y" && clsCommon._strMainPlcConnYn == "Y"))
                    {
                        MAINRoof.qPlc1.Close();
                        //ShowMessageBox.XtraShowInformation("PLC 1번을 연결 해주세요.");
                        sMsg = "PLC 1번 접속을 실패하였습니다";
                        return false;
                    }

                    if (dt.Rows[0]["PLC_TYPE"]?.ToString() == "A" && MAINRoof.SubPlcConnChk != "Y")
                    {
                        MAINRoof.aPlc1.Close();
                    ...
                    // GBG
                    if (dt.Rows[0]["PLC_TYPE"]?.ToString() == "XGI" && MAINRoof.MainPlcConnChk != "Y")
                    {
                        //ShowMessageBox.XtraShowInformation("PLC 1번을 연결 해주세요.");
                    ...
                    if (dt.Rows[0]["PLC_TYPE"]?.ToString() == "CM" && MAINRoof.MainPlcConnChk != "Y")
                    {
                        //ShowMessageBox.XtraShowInformation("PLC 1번을 연결 해주세요.");
                        sMsg = "PLC 1번을 연결 해주세요.";
                        return false;
                    ...
                    break;
                case 2:
                    if (MAINRoof.SubPlcConnChk != "M" && MAINRoof.SubPlcConnChk != "")
                    {
                        if ((dt.Rows[1]["PLC_TYPE"]?.ToString() == "Q" && MAINRoof.SubPlcConnChk != "Y" && clsCommon._strSubPlcConnYn == "Y"))
                        {
                            MAINRoof.qPlc2.Close();
                            //ShowMessageBox.XtraShowInformation("PLC 1번을 연결 해주세요.");
                            sMsg = "PLC 1번 접속을 실패하였습니다";
                            return false;
                        }

                        if (dt.Rows[1]["PLC_TYPE"]?.ToString() == "A" && MAINRoof.SubPlcConnChk != "Y")
                        {
                            MAINRoof.aPlc2.Close();
                            //ShowMessageBox.XtraShowInformation("PLC 1번, 2번 을 먼저 연결 해주세요.");
                            sMsg = "PLC 2번 을 먼저 연결 해주세요.";
                            return false;
                        }

                        if ((MAINRoof.MainPlcConnChk != "Y" && clsCommon._strMainPlcConnYn == "Y") || (MAINRoof.SubPlcConnChk != "Y" && clsCommon._strSubPlcConnYn == "Y"))
                        {
                            //ShowMessageBox.XtraShowInformation("PLC 1번, 2번 을 먼저 연결 해주세요.");
