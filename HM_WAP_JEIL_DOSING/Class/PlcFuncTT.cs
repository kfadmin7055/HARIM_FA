...
namespace HARIM_FA_DOSING.Class
{
    public class PlcFuncTT
    {
        public static int PlcGetDevice(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int[] Cimon_Job_Data = null, int sourceIndex = 0)
        {
            ...
            clsLog.logSave("PLC Read ENTER", 0, "PLC");
            ...
            clsLog.logSave("PLC Read DONE", 0, "PLC");
        ...
        public static int PlcGetDevice(string sPlcType, int iPlc_Location, string sPLCAddress, int[] Cimon_Job_Data = null, int sourceIndex = 0)
        {
            int iPLCDataCount = 15;
        ...
        public static int[] PlcGetReadDeviceAddBlock(DataTable dtPlc, int iPlc_Location, string sPLCAddress, DataRow dr, int Dev, int j, string device, string number, string sErrMsg, int[] Cimon_Result_Data, string sWorkDate = "", string sWorkNum = "")
        {
            ...
            if (clsCommon.PlantCode == "PJ01" && clsCommon.GetProcessKey("갓돈배합") == clsCommon.ProcessCode)
            {
                MAIN_TT.aPlc2.ReadADeviceAddBlockEx(device, int.Parse(number), (5 * j), iPLCDataCount, out valData, sErrMsg);
                return valData;
            }
            // GBG4 -
            ...
            if (iPlc_Location == 1 && dtPlc.Rows[iPlc_Location - 1]["PLC_TYPE"]?.ToString() == "Q")
            {
                ...
                for (int k = 0; k < 3; k++)
                {
                    MAIN_TT.qPlc1.ReadQDeviceAddBlockEx(device, int.Parse(number), (5 * j), iPLCDataCount, out valData, sErrMsg);
                }
            }
            else if (iPlc_Location == 1 && dtPlc.Rows[iPlc_Location - 1]["PLC_TYPE"]?.ToString() == "A")
            {
                ...
                for (int k = 0; k < 3; k++)
                {
                    MAIN_TT.aPlc1.ReadADeviceAddBlockEx(device, int.Parse(number), (5 * j), iPLCDataCount, out valData, sErrMsg);
                }
            }
            else if (iPlc_Location == 2 && dtPlc.Rows[iPlc_Location - 1]["PLC_TYPE"]?.ToString() == "Q")
            {
                ...
                for (int k = 0; k < 3; k++)
                {
                    MAIN_TT.qPlc2.ReadQDeviceAddBlockEx(device, int.Parse(number), (5 * j), iPLCDataCount, out valData, sErrMsg);
                }
            }
            else if (iPlc_Location == 2 && dtPlc.Rows[iPlc_Location - 1]["PLC_TYPE"]?.ToString() == "A")
            {
        ...
        public static int[] PlcGetReadDeviceAddBlock(string sPlctype, int iPlc_Location, string sPLCAddress, DataRow dr, int Dev, int j, string device, string number, string sErrMsg, int[] Cimon_Result_Data, string sWorkDate = "", string sWorkNum = "")
        {
            int iPLCDataCount = 15;
            ...
            else if (iPlc_Location == 1 && sPlctype == "XGI")
            {
                int.TryParse(sPLCAddress.Substring(3), out int addr);
            ...
            else if (iPlc_Location == 1 && sPlctype == "CM")
            {
                sAddress = $"{Dev}";
                Array.Copy(Cimon_Result_Data, ((Dev - 1) * 100) + (j * 5), valData, 0, iPLCDataCount);
            }
        ...
        /// <returns></returns>
        public static bool PlcGetReadQDeviceBlockEx(string sPlcType, int iPlc_Location, string sPLCAddress, ref int[] pWorkNum, string sErrMsg, int[] Cimon_Job_Data = null, int sourceIndex = 0)
        {
            int iPLCDataCount = 15;
            ...
            if (iPlc_Location == 1 && sPlcType == "Q")
            {
                if (MAIN_TT.qPlc1.ReadQDeviceBlockEx(sPLCAddress, iPLCDataCount, out pWorkNum, sErrMsg) != 0)
                {
                ...
                {
                    MAIN_TT.MainPlcConnChk = "Y";
                }
            }
            // GBG
            else if (iPlc_Location == 1 && sPlcType == "A")
            {
                if (MAIN_TT.aPlc1.ReadADeviceBlockEx(sPLCAddress, iPLCDataCount, out pWorkNum, sErrMsg) != 0)
                {
                    MAIN_TT.MainPlcConnChk = "N";
                    returnBool = false;
                }
            ...
            {
                if (MAIN_TT.qPlc2.ReadQDeviceBlockEx(sPLCAddress, iPLCDataCount, out pWorkNum, sErrMsg) != 0)
                {
                    MAIN_TT.MainPlcConnChk = "N";
                    returnBool = false;
                }
            ...
            {
                if (MAIN_TT.aPlc2.ReadADeviceBlockEx(sPLCAddress, iPLCDataCount, out pWorkNum, sErrMsg) != 0)
                {
                    MAIN_TT.MainPlcConnChk = "N";
                    returnBool = false;
                }
        ...
        public static bool PLCSetWriteQDeviceBlock2Ex(DataTable dtPlc, int iPlc_Location, string sPLCAddress, ref short[] Sdata, int[] Sdata2, string sErrMsg = "")
        {
            ...
            if (iPlc_Location == 1 && sPlcType == "Q")
            {
                if (MAIN_TT.qPlc1.WriteQDeviceBlock2Ex(sPLCAddress, iPLCDataCount, ref Sdata, sErrMsg) != 0)
                {
                    MAIN_TT.MainPlcConnChk = "N";
                    return false;
                }
            ...
            {
                if (MAIN_TT.aPlc1.WriteADeviceBlock2Ex(sPLCAddress, iPLCDataCount, ref Sdata, sErrMsg) != 0)
                {
                    MAIN_TT.MainPlcConnChk = "N";
                    return false;
                }
            ...
            {
                if (MAIN_TT.qPlc2.WriteQDeviceBlock2Ex(sPLCAddress, iPLCDataCount, ref Sdata, sErrMsg) != 0)
                {
                    MAIN_TT.SubPlcConnChk = "N";
                    return false;
                }
                else
                {
                    MAIN_TT.SubPlcConnChk = "Y";
                }
            }
            else if (iPlc_Location == 2 && sPlcType == "A")
            {
                if (MAIN_TT.aPlc2.WriteADeviceBlock2Ex(sPLCAddress, iPLCDataCount, ref Sdata, sErrMsg) != 0)
                {
                    MAIN_TT.SubPlcConnChk = "N";
                    return false;
                }
        ...
        public static bool PlcSetQDeviceEx(DataTable dtPlc, int iPlc_Location, string sPLCAddress, DataRow dr, int batch, int[] pWorkNum, string sErrMsg)
        {
            ...
            {
                if (MAIN_TT.qPlc1.SetQDeviceEx(sPLCAddress, pWorkNum[0], sErrMsg) != 0)
                {
                    MAIN_TT.MainPlcConnChk = "N";
                    returnBool = false;
                }
            ...
            {
                if (MAIN_TT.aPlc1.SetADeviceEx(sPLCAddress, pWorkNum[0], sErrMsg) != 0)
                {
                    MAIN_TT.MainPlcConnChk = "N";
                    returnBool = false;
                }
            ...
            {
                if (MAIN_TT.qPlc2.SetQDeviceEx(sPLCAddress, pWorkNum[0], sErrMsg) != 0)
                {
                    MAIN_TT.MainPlcConnChk = "N";
                    returnBool = false;
                }
            ...
            {
                if (MAIN_TT.aPlc2.SetADeviceEx(sPLCAddress, pWorkNum[0], sErrMsg) != 0)
                {
                    MAIN_TT.MainPlcConnChk = "N";
                    returnBool = false;
                }
        ...
        public static bool PlcSetWriteQDeviceAddBlockEx(DataTable dtPlc, int iPlc_Location, string sPLCAddress, int Dev, int j, ref int[] pWorkNum, int[] Recipe_Data, ref int Recipe_D1_Index, ref int Recipe_D2_Index, ref int Recipe_D3_Index, ref int Recipe_L1_Index, ref int Recipe_L2_Index, string device, string number, string sErrMsg)
        {
            ...
            if (sPlcType == "Q" && iPlc_Location == 1)
            {
                if (MAIN_TT.qPlc1.WriteQDeviceAddBlockEx(device, int.Parse(number), (j * 5), iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            // GBG
            else if (sPlcType == "A" && iPlc_Location == 1)
            {
                if (MAIN_TT.aPlc1.WriteADeviceAddBlockEx(device, int.Parse(number), (j * 5), iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            else if (sPlcType == "Q" && iPlc_Location == 2)
            {
                if (MAIN_TT.qPlc2.WriteQDeviceAddBlockEx(device, int.Parse(number), (j * 5), iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            // GBG
            else if (sPlcType == "A" && iPlc_Location == 2)
            {
                if (MAIN_TT.aPlc2.WriteADeviceAddBlockEx(device, int.Parse(number), (j * 5), iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            else if (sPlcType == "XGI")
            {
        ...
        public static bool SetWriteQDeviceBlockEx(DataTable dtPlc, int iPlc_Location, string sPLCAddress, ref int[] pWorkNum, string sErrMsg)
        {
            ...
            if (sPlcType == "Q" && iPlc_Location == 1)
            {
                ...
                if (MAIN_TT.qPlc1.WriteQDeviceBlockEx(sPLCAddress, iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            // GBG
            else if (sPlcType == "A" && iPlc_Location == 1)
            {
                if (MAIN_TT.aPlc1.WriteADeviceBlockEx(sPLCAddress, iPLCDataCount, pWorkNum, sErrMsg) != 0)
                    return false;
            }
            else if (sPlcType == "Q" && iPlc_Location == 2)
            {

                if (MAIN_TT.qPlc2.WriteQDeviceBlockEx(sPLCAddress, iPLCDataCount, ref pWorkNum, sErrMsg) != 0)
                    return false;
            }
            // GBG
            else if (sPlcType == "A" && iPlc_Location == 2)
            {
                if (MAIN_TT.aPlc2.WriteADeviceBlockEx(sPLCAddress, iPLCDataCount, pWorkNum, sErrMsg) != 0)
                    return false;
            }
            else if (sPlcType == "XGI")
            {
        ...
        public static bool GetPlcCon(DataTable dt, out string sMsg)
        {
            ...
            {
                case 1:
                    if ((dt.Rows[0]["PLC_TYPE"]?.ToString() == "Q" && MAIN_TT.MainPlcConnChk != "Y" && clsCommon._strMainPlcConnYn == "Y"))
                    {
                        MAIN_TT.qPlc1.Close();
                    ...
                    if (dt.Rows[0]["PLC_TYPE"]?.ToString() == "A" && MAIN_TT.SubPlcConnChk != "Y")
                    {
                        MAIN_TT.aPlc1.Close();
                    ...
                    // GBG
                    if (dt.Rows[0]["PLC_TYPE"]?.ToString() == "XGI" && MAIN_TT.MainPlcConnChk != "Y")
                    {
                        //ShowMessageBox.XtraShowInformation("PLC 1번을 연결 해주세요.");
                    ...
                    if (dt.Rows[0]["PLC_TYPE"]?.ToString() == "CM" && MAIN_TT.MainPlcConnChk != "Y")
                    {
                        //ShowMessageBox.XtraShowInformation("PLC 1번을 연결 해주세요.");
                        sMsg = "PLC 1번을 연결 해주세요.";
                        return false;
                    ...
                    break;
                case 2:
                    if (MAIN_TT.SubPlcConnChk != "M" && MAIN_TT.SubPlcConnChk != "")
                    {
                        if ((dt.Rows[1]["PLC_TYPE"]?.ToString() == "Q" && MAIN_TT.SubPlcConnChk != "Y" && clsCommon._strSubPlcConnYn == "Y"))
                        {
                            MAIN_TT.qPlc2.Close();
                            //ShowMessageBox.XtraShowInformation("PLC 1번을 연결 해주세요.");
                            sMsg = "PLC 1번 접속을 실패하였습니다";
                        ...
                        if (dt.Rows[1]["PLC_TYPE"]?.ToString() == "A" && MAIN_TT.SubPlcConnChk != "Y")
                        {
                            MAIN_TT.aPlc2.Close();
                            //ShowMessageBox.XtraShowInformation("PLC 1번, 2번 을 먼저 연결 해주세요.");
                            sMsg = "PLC 2번 을 먼저 연결 해주세요.";
                        ...
                        if ((MAIN_TT.MainPlcConnChk != "Y" && clsCommon._strMainPlcConnYn == "Y") || (MAIN_TT.SubPlcConnChk != "Y" && clsCommon._strSubPlcConnYn == "Y"))
                        {
                            //ShowMessageBox.XtraShowInformation("PLC 1번, 2번 을 먼저 연결 해주세요.");
