...
{
    public partial class MAIN_TT : DevExpress.XtraEditors.XtraForm
    {
        /// <summary>        /// 실행 경로y
        /// </summary>
        ...
        private void XSetBatchComplete(string sPlctype, string sProcessKey, string sLCode, int iPlcNo)
        {
            try
            {
                ...
                lock (plcLock)   // Read 중복을 완전히 차단
                {
                    sData[0] = PlcFuncTT.PlcGetDevice(sPlctype, iPlcNo, vPLC_Location == 1 ? clsPlcAddress.BatchComPlate : clsPlcAddress.BatchComPlate2, Cimon_Job_Data, BATCH_COMPLETE);
                }
